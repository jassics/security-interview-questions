...
11. [Scenario-Based Questions](#scenario-based-questions)
    1. [Scenario 1: RAG chatbot cross-customer data leak](#scenario-1-customer-support-chatbot-leaks-another-customers-order-data)
    2. [Scenario 2: Coding agent commits a hardcoded API key](#scenario-2-an-internal-ai-coding-assistant-agent-is-asked-to-fix-the-failing-test-and-it-commits-a-hardcoded-api-key)
    3. [Scenario 3: Text-to-SQL agent against production DB](#scenario-3-marketing-team-wants-to-connect-an-llm-directly-to-the-production-database-for-a-natural-language-analytics-feature)
    4. [Scenario 4: System prompt leak exposes internal endpoint](#scenario-4-a-user-discovers-they-can-get-your-public-facing-llm-chatbot-to-output-its-full-system-prompt-including-an-internal-api-endpoint-url)
    5. [Scenario 5: Multi-agent handoff auto-files a fraudulent expense claim](#scenario-5-multi-agent-research-system-one-agent-summarizes-web-pages-another-agent-uses-those-summaries-to-auto-file-expense-reports)
    6. [Scenario 6: Vetting a third-party open-source model before production use](#scenario-6-youre-asked-to-sign-off-on-using-a-third-party-open-source-model-downloaded-from-a-public-model-hub-for-a-production-feature)
    7. [Scenario 7: Data poisoning via a user-dispute feedback loop](#scenario-7-your-fraud-detection-models-accuracy-quietly-degrades-after-you-started-accepting-user-submitted-report-as-legitimate-feedback-to-retrain-it)
    8. [Scenario 8: Model theft/extraction via API querying](#scenario-8-a-competitor-launches-a-model-that-behaves-suspiciously-similar-to-yours-a-few-months-after-opening-your-model-api-to-paying-customers)
    9. [Scenario 9: Model DoS / denial-of-wallet from token flooding](#scenario-9-your-llm-powered-support-bots-cloud-bill-spikes-40x-overnight-and-the-service-becomes-unresponsive-for-real-customers)
    10. [Scenario 10: Jailbreak via roleplay/fictional framing](#scenario-10-a-user-gets-your-safety-aligned-chatbot-to-produce-disallowed-content-by-asking-it-to-write-a-story-where-a-character-explains-step-by-step-how-to)
    11. [Scenario 11: Adversarial-example evasion of an image classifier](#scenario-11-your-image-based-content-moderation-classifier-stops-flagging-a-category-of-policy-violating-images-that-a-human-reviewer-catches-instantly)
    12. [Scenario 12: Backdoored model artifact from a public hub](#scenario-12-a-quantized-3x-faster-community-re-upload-of-your-base-model-on-a-public-hub-turns-out-to-have-a-hidden-backdoor)
    13. [Scenario 13: Compromised third-party agent plugin exfiltrates data](#scenario-13-a-third-party-calendar-assistant-plugin-you-connected-to-your-internal-ai-agent-starts-exfiltrating-meeting-notes-to-an-external-domain)
    14. [Scenario 14: System prompt leakage via translation laundering](#scenario-14-a-translate-this-back-to-me-trick-leaks-your-system-prompt-even-though-you-already-block-direct-requests-for-it)
    15. [Scenario 15: Insecure output handling — XSS and command injection](#scenario-15-your-ai-coding-assistants-chat-ui-executes-an-attackers-javascript-the-moment-it-renders-the-models-answer)
    16. [Scenario 16: Excessive agency — manipulated refund approval](#scenario-16-a-customer-support-agent-with-refund-authority-gets-talked-into-issuing-a-refund-it-should-never-have-approved)
    17. [Scenario 17: Privacy attack — training data extraction](#scenario-17-a-researcher-extracts-verbatim-snippets-of-your-fine-tuning-data-including-a-customers-real-email-correspondence-just-by-asking-the-model-to-repeat-a-word-forever)
    18. [Scenario 18: Training data pipeline supply-chain compromise](#scenario-18-a-compromised-preprocessing-dependency-in-your-nightly-data-pipeline-silently-backdoors-every-training-run-for-weeks-before-anyone-notices)
    19. [Scenario 19: Red-team engagement scoped too narrowly](#scenario-19-a-red-team-engagement-passed-your-new-agentic-feature-two-weeks-before-launch-then-it-got-exploited-in-production-on-day-three)
    20. [Scenario 20: Shadow AI and the governance gap](#scenario-20-three-different-teams-independently-ship-genai-features-with-wildly-inconsistent-risk-controls-and-nobody-in-security-even-knew-about-two-of-them)
    21. [Scenario 21: Multi-agent impersonation of a privileged role](#scenario-21-a-rogue-agent-joins-your-multi-agent-orchestration-and-impersonates-the-verified-compliance-reviewer-role-and-every-other-agent-believes-it)
    22. [Scenario 22: Shared multi-agent scratchpad/memory poisoning](#scenario-22-one-compromised-agent-poisons-a-shared-scratchpad-memory-and-every-other-agent-that-reads-it-inherits-the-manipulation)
    23. [Scenario 23: Undetected model bias in loan approvals](#scenario-23-your-ai-assisted-loan-approval-model-approves-qualified-applicants-at-very-different-rates-across-demographic-groups-and-nobody-flagged-it-before-launch)
